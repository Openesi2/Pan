...
class SoftwarePanel(Screen):
	...
	def __init__(self, session, *args):
		...
		<screen name="SoftwarePanel" position="center,center" size="650,605" title="Software Panel">
			<widget name="a_off" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/EsiPanel/icons/aoff.png" position="10,10" zPosition="1" size="36,97" alphatest="on" />
			<widget name="a_red" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/EsiPanel/icons/ared.png" position="10,10" zPosition="1" size="36,97" alphatest="on" />
			<widget name="a_yellow" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/EsiPanel/icons/ayellow.png" position="10,10" zPosition="1" size="36,97" alphatest="on" />
			<widget name="a_green" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/EsiPanel/icons/agreen.png" position="10,10" zPosition="1" size="36,97" alphatest="on" />
	...
	def checkTraficLight(self):
		...
		try:
			urlopenESI = "http://www.openesi.eu/Green/green.png"
