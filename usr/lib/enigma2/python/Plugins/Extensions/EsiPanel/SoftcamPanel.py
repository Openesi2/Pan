...
class ShowSoftcamPackages(Screen):
	...
	def setStatus(self,status = None):
		if status:
			...
			if status == 'update':
				statuspng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_PLUGIN, "Extensions/EsiPanel/icons/upgrade.png"))
			...
			if status == 'list':
				...
				statuspng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_PLUGIN, "Extensions/EsiPanel/icons/remove.png"))
	...
	def buildEntryComponent(self, name, version, description, state):
		...
		if not description:
			description = ""
		installedpng = LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_PLUGIN, "Extensions/EsiPanel/icons/installed.png"))
